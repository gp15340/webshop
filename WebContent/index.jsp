...
<div class="w_100_l top_title">
	<div class="main">
		<c:if test="${user.userName==null}">
			<p><a href="#">Buy more than one book and save big! </a><a href="userLogin.jsp">欢迎您：请先登录</a></p>
		</c:if>
		<c:if test="${user.userName!=null}">
			<p><a href="#">Buy more than one book and save big! </a><a href="userDetail.jsp" target="_blank"><img src="${user.avatarUrl}" width="30" height="30"  />欢迎您：${user.userName}</a></p>
		</c:if>
...
<div class="w_100_l">
	<div class="main">
      <div class="top_banner">
            ...
            <div class="top_menu">
            	<ul>
                	...
                	<li><a href="adminLogin.jsp">管理员登录窗口</a></li>
                </ul>
            </div>
            <div class="top_shop_cur"><a href="showCart.do" target="_blank"><img src="Images/top_shop_cur.jpg" alt="shopping car" /></a></div>
        </div>
      ...
      <div class="content">
            ...
            <a href="loadBookList.do">全部商品</a>
            <c:forEach items="${typelist}" var="type">
            <a href="selectBookByType.do?typeId=${type.typeId}">${type.typeName}</a>
             </c:forEach>
             <form action="searchBookByName.do" method="post">
	图书名称:
	<input type="text" name="bookName"  />
	<input type="submit" value="搜索" />
	</form>
            <a href="showHotBook.do">热门商品</a>
        	<ul>
        	<c:forEach items="${booklist}" var="book">
            	<li>
                	<dl>
                    	<dd><a href="selectOneBook.do?bookId=${book.bookId}" target="_blank"><img src="${book.imgUrl}" alt="book" width="100" height="120"/></a></dd>
                        <dt>
                        	<p class="book_title"><a href="selectOneBook.do?bookId=${book.bookId}" target="_blank">${book.bookName}</a></p>
                            <p class="book_inline">${book.bookPrice}</p>
                            <a class="book_buy" href="selectOneBook.do?bookId=${book.bookId}" target="_blank">BUY</a>
                        </dt>
                    </dl>
                </li>
            </c:forEach>
      ...
      <div>
      	 <table align="center">
			...
			<a href="loadBookList.do?pageS=1">首页</a>&nbsp;&nbsp;&nbsp;
			<c:if test="${page.dpage!=1}">
			<a href="loadBookList.do?pageS=${page.dpage-1}">上一页</a>&nbsp;&nbsp;&nbsp;
			</c:if>
			<c:if test="${page.dpage!=page.totalpage}">
			<a href="loadBookList.do?pageS=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
			</c:if>
			<a href="loadBookList.do?pageS=${page.totalpage}">尾页</a>
		</td>
		</tr>
		</table>
      </div>
