...
<table border="1">
	...
	<tr><td colspan="12" align="center">
			<a href="showAllBook.do?pageS=1">首页</a>&nbsp;&nbsp;&nbsp;
			<c:if test="${page.dpage!=1}">
			<a href="showAllBook.do?pageS=${page.dpage-1}">上一页</a>&nbsp;&nbsp;&nbsp;
			</c:if>
			<c:if test="${page.dpage!=page.totalpage}">
			<a href="showAllBook.do?pageS=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
			</c:if>
			<a href="showAllBook.do?pageS=${page.totalpage}">尾页</a>
		</td>
		</tr>
