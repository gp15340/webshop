...
<div class="w_100_l">
	<div class="main">
      <div class="top_banner">
            ...
            <div class="top_shop_cur"><a href="showCart.do"><img src="Images/top_shop_cur.jpg" alt="shopping car" /></a></div>
        </div>
	...
	<input type="submit" value="搜索" />
      ...
      <div>
      	 <table align="center">
			...
			<a href="showHotBook.do?pageS=1">首页</a>&nbsp;&nbsp;&nbsp;
			<c:if test="${page.dpage!=1}">
			<a href="showHotBook.do?pageS=${page.dpage-1}">上一页</a>&nbsp;&nbsp;&nbsp;
			</c:if>
			<c:if test="${page.dpage!=page.totalpage}">
			<a href="showHotBook.do?pageS=${page.dpage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
			</c:if>
			<a href="showHotBook.do?pageS=${page.totalpage}">尾页</a>
		</td>
		</tr>
		</table>
      </div>
